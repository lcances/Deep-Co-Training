...
# Run ubs8K models
run_ubs8k() {
    commun_args="--dataset ubs8k --batch_size 100 --learning_rate 0.003 \
                 --nb_epoch 300 --supervised_ratio 0.1 --num_classes 10 \
                 -t 1 2 3 4 5 6 7 8 9 -v 10"

    srun -n 1 -N 1 singularity exec \${container} \${python} \${script} --model $MODEL \${commun_args}
}

# Run esc10 models
run_esc10() {
    commun_args="--dataset esc10 --batch_size 100 --learning_rate 0.003 \
                 --nb_epoch 300 --supervised_ratio 0.1 --num_classes 10 \
                 -t 1 2 3 4 -v 5"
...
# Run esc50 models
run_esc50() {
    commun_args="--dataset esc50 --batch_size 100 --learning_rate 0.003 \
                 --nb_epoch 300 --supervised_ratio 0.1 --num_classes 50 \
                 -t 1 2 3 4 -v 5"
...
run_speechcommand() {
    commun_args="--dataset SpeechCommand --batch_size 256 --learning_rate 0.003 \
                 --nb_epoch 300 --supervised_ratio 0.1 --num_classes 35"
