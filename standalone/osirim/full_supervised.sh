...
# Run ubs8K models
run_ubs8k() {
    dataset_args="--dataset ubs8k --batch_size 64 --learning_rate 0.003 \
                 --nb_epoch 200 --num_classes 10 \
...
# Run esc10 models
run_esc10() {
    dataset_args="--dataset esc10 --batch_size 64 --learning_rate 0.003 \
                 --nb_epoch 200 --num_classes 10 \
                 -t 1 2 3 4 -v 5"
...
# Run esc50 models
run_esc50() {
    dataset_args="--dataset esc50 --batch_size 64 --learning_rate 0.003 \
                 --nb_epoch 200 \${RATIO} --num_classes 50 \
                 -t 1 2 3 4 -v 5"
...
run_speechcommand() {
    dataset_args="--dataset SpeechCommand --batch_size 256 --learning_rate 0.003 \
                 --nb_epoch 200 --num_classes 35"
