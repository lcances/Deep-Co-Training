...
parser.add_argument("--augment_S", action="store_true", help="augmentation will apply on supervised part")
...
adv_augmentation = args.augment_adv

train_augmentation = ()
for augment_name in args.augment:
    train_augmentation += (augmentations[augment_name], )
...
train_dataset = Dataset(manager, folds=args.train_folds, augments=train_augmentation, cached=True)
