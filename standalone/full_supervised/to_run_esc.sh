...
common_param="--dataset esc50 --learning_rate 0.001  --batch_size 64 --epoch 200 --ratio 0.1 --num_classes 50"
bash full_supervised_esc.sh --model cnn03 ${common_param}
bash full_supervised_esc.sh --model resnet18 ${common_param}
bash full_supervised_esc.sh --model resnet34 ${common_param}
bash full_supervised_esc.sh --model resnet50 ${common_param}
bash full_supervised_esc.sh --model esc_wideresnet28_2 ${common_param}
bash full_supervised_esc.sh --model esc_wideresnet28_4 ${common_param}
bash full_supervised_esc.sh --model esc_wideresnet28_8 ${common_param}
