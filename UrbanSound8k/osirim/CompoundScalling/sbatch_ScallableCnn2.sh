...
#SBATCH --job-name=ScallableCnn2
#SBATCH --output=%j_%t_ScallableCnn2.out
#SBATCH --error=%j_%t_ScallableCnn2.err
#SBATCH --ntasks=2
...
init_conv="--init_conv_inputs 1 44 89 89 89 111 --init_conv_outputs 44 89 89 89 111 133"
...
fixed_parameters="--tensorboard_dir tensorboard/ScallableCnn2 ${init_model_param} --epochs 200"
