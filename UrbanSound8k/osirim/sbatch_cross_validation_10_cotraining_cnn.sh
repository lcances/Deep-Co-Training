...
#SBATCH --job-name=50_dct_cnn
#SBATCH --output=%j_%t_50_dct_cnn.out
#SBATCH --error=%j_%t_50_dct_cnn.err
#SBATCH --ntasks=4
...
fixed_parameters="--epochs 600 -T tensorboard/0.5r_cnn_cross_validation --ratio 0.5"
hyper_parameters="--base_lr 0.01 --epsilon 0.1 --lambda_cot_max 5 --lambda_diff_max 0.25 --warm_up 160"
