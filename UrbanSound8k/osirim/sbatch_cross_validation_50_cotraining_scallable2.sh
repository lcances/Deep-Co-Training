...
#SBATCH --job-name=50_dct_scallable2
#SBATCH --output=%j_%t_50_dct_scallable2.out
#SBATCH --error=%j_%t_50_dct_scallable2.err
#SBATCH --ntasks=4
...
fixed_parameters="--epochs 600 -T tensorboard/0.5r_scallable2_cross_validation --ratio 0.5"
